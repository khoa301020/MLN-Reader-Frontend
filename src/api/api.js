...
export const mangaApi = {
    ...
    createMangaSection: (data) => api.post("/manga/create-section", Object.assign({ subject: "section" }, data)),
    ...
    createMangaChapter: (data) => api.post("/manga/create-chapter", Object.assign({ subject: "chapter" }, data)),
