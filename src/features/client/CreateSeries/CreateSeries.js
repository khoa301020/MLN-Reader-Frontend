                    ...
                    <div className='row-start-3 col-start-3 col-span-8 bg-white min-h-screen h-auto border-solid border border-gray-400 rounded mb-20'>
                        ...
                        <div className='px-8 py-10 min-h-screen'>
                            ...
                            <div className='grid grid-cols-9 gap-9 content-center mb-4'>
                                ...
                                <div className='col-span-6'>
                                    <input class="block w-full text-sm py-2 text-gray-900 border cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file"></input>
                                </div>
                            </div>
                            ...
                            <div className='grid grid-cols-9 gap-9 content-center mb-4'>
                                ...
                                <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 border border-solid border-transparent font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Thêm truyện</button>
                                </div>
                            </div>
