        ...
        <div className="col-start-2 col-span-10 h-auto mt-10">
          ...
          <div className="grid xl:grid-cols-4 lg:grid-cols-4 gap-10 md:grid-cols-1 sm:grid-cols-1">
            <div className="col-span-3 w-full">
              ...
              <div className="Comment w-auto h-fit bg-zinc-800 border border-solid border-zinc-700 rounded-md mt-8 pb-3 mb-10">
                <div className="grid grid-cols-6 sm:grid-col-1">
                  ...
                  <div className="col-span-9 w-full h-fit p-6 pb-4 font-bold text-2xl rounded-t-md">
                    {!isLogged ? (
