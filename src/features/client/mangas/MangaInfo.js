              ...
              <div className="max-w-full h-fit bg-white border border-solid border-gray-400 rounded-md">
                ...
                <div class="py-5 w-full h-auto border-y border-x-0 border-gray-200 border-solid">
                  <div class="flex flex-col justify-center items-center cursor-pointer" onClick={handleFollow}>
                    <div>
                      {isFollowing ? (
                        <HeartFilled style={{ fontSize: '32px', color: '#fda4af' }} />
                      ) : (
                        <HeartOutlined style={{ fontSize: '32px', color: '#fb7185' }} />
                      )}
                    </div>
                    <div class="text-rose-300 mt-1 font-semibold hover:text-rose-400">{followCount}</div>
                  </div>
                </div>
              ...
              {auth && (
                <div class="w-full bg-white h-fit rounded-md p-3 border border-solid border-gray-400">
                  <Space direction="vertical" style={{ width: '100%' }}>
                    ...
                    <Link to="/action/update-series/manga-volume">
